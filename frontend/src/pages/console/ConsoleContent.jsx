    ...
    <div className="con-screen">
      ...
      <div className="con-head-row">
        <div>
          ...
          <p className="con-sub" style={{ maxWidth: 560 }}>
            ...
            поле «Позиция», скрытые блоки на сайте не показываются.
          </p>
        </div>
      ...
      {blocks.length ? (
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          {blocks.map((b) => (
            <div key={b.id} className="con-card con-block-row">
              <span style={{ width: 36, height: 36, borderRadius: 9, background: "var(--accent-wash)", color: "var(--accent)", display: "grid", placeItems: "center", fontFamily: "var(--con-mono)", fontSize: 13, fontWeight: 600 }}>{b.position}</span>
